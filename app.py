                ...
                if st.button("💡 Run Topic Prediction"):
                    with st.spinner("⏳ Generating topic clusters... please wait..."):
                        ...
                        if not df_neg.empty:
                            ...
                            df_neg["lemmatized_text"] = df_neg["clean_text"].apply(lemmatize_text)
                        ...
                        if not df_net.empty:
                            ...
                            df_net["lemmatized_text"] = df_net["clean_text"].apply(lemmatize_text)
                        ...
                        if not df_pos.empty:
                            ...
                            df_pos["lemmatized_text"] = df_pos["clean_text"].apply(lemmatize_text)
